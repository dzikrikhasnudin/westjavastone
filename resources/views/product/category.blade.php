                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="{{ route('front.category') }}"
                                        class="ms-1 text-sm font-medium text-gray-700 hover:text-sky-600 dark:text-gray-400 dark:hover:text-white md:ms-2">Category</a>
                                </div>
                            </li>
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="#"
                                        class="ms-1 text-sm font-medium text-gray-700 hover:text-sky-600 dark:text-gray-400 dark:hover:text-white md:ms-2">{{
                                        $category->name }}</a>
                                </div>
                            </li>
                        </ol>
                    </nav>
                    <h2 class="mt-3 text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Category: {{
                        $category->name }}</h2>
                </div>
