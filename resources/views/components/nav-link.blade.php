...
: 'block py-2 pr-4 pl-3 text-gray-50 border-b border-gray-100 hover:bg-gray-50 hover:text-sky-700
lg:hover:bg-transparent lg:border-0 lg:hover:text-sky-600 lg:hover:underline lg:p-0 dark:text-gray-400
